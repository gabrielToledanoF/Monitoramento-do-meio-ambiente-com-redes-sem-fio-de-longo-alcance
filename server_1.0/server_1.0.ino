...
int i = 1, j = 0;                    //Variáveis para caminharmos pelo sf e cr
...
void setup() {
  ...
  if (!rf95.init()){//Caso o modulo falhe a inicialização
...
void loop() {
  ...
  Serial.println("Para essa sequencia foram recebidas " + String(S) + " mensagens e " + String(F) + " mensagens falharam.");
